...
const TransformationRight = () => {
    return(<div id="TransformationRight">
            <div>
                <div className="flex flex-col justify-around mt-20 text-center
                lg:flex-row lg:text-start lg:m-auto lg:mt-20">
                    <div>
                        <label>
                            Name 
                        </label>
                        <input className="mx-auto block outline-none w-full p-2 pl-6 text-gray-600 bg-gray-300 rounded-4xl
                        sm:w-[300px]" type="text" value="Your Full Name"></input>
                    </div>
                    ...
                    <div>
                        ...
                        <input className="mx-auto block outline-none w-full p-2 pl-6 text-gray-600 bg-gray-300 rounded-4xl
                        sm:w-[300px]" type="text" value="your.email@company.com"></input>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                lg:flex-row lg:text-start lg:m-auto lg:mt-20">
                    <div>
                        ...
                        <input className="mx-auto block outline-none w-full p-2 pl-6 text-gray-600 bg-gray-300 rounded-4xl
                        sm:w-[300px]" type="text" value="Your Company Name"></input>
                    </div>
                    ...
                    <div>
                        ...
                        <input className="mx-auto block outline-none w-full p-2 pl-6 text-gray-600 bg-gray-300 rounded-4xl
                        sm:w-[300px]" type="text" value="Your Phone Number"></input>
                    </div>
                </div>
                ...
                lg:mx-10 lg:mt-10">
                    <div>
                        ...
                        <textarea className="h-[200px] block outline-none w-full p-2 pl-6 text-gray-600 bg-gray-300 rounded-4xl" type="text" 
                        value="Your Company Name"></textarea>
                    </div>
                </div>

                <div className="text-end p-5">
                    <button className="w-full bg-black text-white p-2 rounded-3xl cursor-pointer
                    sm:w-[200px]">Send Message
...
export default TransformationRight;