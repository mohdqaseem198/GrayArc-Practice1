    ...
    return(<div className="mt-20" id="car">
        ...
        md:grid md:grid-cols-3">
            ...
            ">
                ...
                sm:p-20">Connect with our SAP supply chain experts and discover how we can deliver up to 20% logistics cost reduction while ensuring regulatory compliance across pharmaceutical, chemical, and agrochemical operations.</h2>
            </div>
            <div className=" mt-5 text-center bg-gray-300 rounded-4xl
            sm:mt-5 sm:ml-0
            md:mt-0 md:ml-5">
                <div className="flex flex-col justify-center gap-10 items-center">
                    <Image className="w-[100px] mt-20" src="/Calender.svg" height={0} width={100} />
                    <div className="w-full">
                    <button className="w-full bg-black text-white p-2 rounded-3xl cursor-pointer
                    md:w-[200px]
                    lg:w-[250px]">Schedule an appointment
