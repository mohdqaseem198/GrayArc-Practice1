...
const Car = () => {
    return(<div className="mt-20" id="car">
        <div className="grid grid-cols-1
        md:grid md:grid-cols-3">
            <div className="grid-cols-1">
                <Image className="w-full" src="/Car.png" height={0} width={200} />
            </div>
        ...
        md:grid md:grid-cols-3">
            <div className="col-span-2 flex items-center text-center rounded-4xl  bg-gray-300
            ">
                <h2 className="p-20 text-[25px]">Connect with our SAP supply chain experts and discover how we can deliver up to 20% logistics cost reduction while ensuring regulatory compliance across pharmaceutical, chemical, and agrochemical operations.</h2>
            </div>
            <div className="grid-cols-1 flex flex-col mt-5 text-center bg-gray-300 rounded-4xl
            sm:mt-0 sm:ml-5">
                <Image className="w-[100px] m-auto" src="/Calender.svg" height={0} width={100} />
                <div>
